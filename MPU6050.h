...
// accell band [Hz], accel delay [ms], gyro band [Hz], gyro delay [ms]
typedef enum
{
    MPU6050_DLPF_6                = 0b110,  //   5, 19.0,   5, 18.6
    MPU6050_DLPF_5                = 0b101,  //  10, 13.8,  10, 13.4
    MPU6050_DLPF_4                = 0b100,  //  21,  8.5,  20,  8.3
    MPU6050_DLPF_3                = 0b011,  //  44,  4.9,  42,  4.8
    MPU6050_DLPF_2                = 0b010,  //  94,  3.0,  98,  2.8
    MPU6050_DLPF_1                = 0b001,  // 184,  2.0, 188,  1.9 
    MPU6050_DLPF_0                = 0b000,  // 260,  0.0, 256,  0.98
} mpu6050_dlpf_t;
...
class MPU6050
{
  public:
    ...
    Vector getGyroCalibration(void);
  ...
  private:
  	...
  	float dpsPerDigit, rangePerDigit, actualThreshold;
  	bool useCalibrate;
  	int mpuAddress;
